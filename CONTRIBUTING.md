# Contributing to NexGrid

Thank you for your interest in contributing! NexGrid is an open-source, MIT-licensed
...
dotnet/             NexGrid.AspNetCore  ASP.NET Core Tag Helper + IQueryable server extensions
...
Open an issue with:
- the package and version (`@nexgrid/react 0.1.0`, `NexGrid.AspNetCore 0.1.0`, ...)
