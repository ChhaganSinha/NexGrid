...
export function App() {
  ...
  const toolbarActions = (
    <>
      ...
      >
        {theme === "dark" ? (
          <svg className="tbx-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
