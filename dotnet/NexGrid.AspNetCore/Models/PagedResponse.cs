// The server -> client half of the NexGrid contract.
//
// The property names are pinned with [JsonPropertyName] instead of relying on
// ASP.NET Core's camelCase default. The wire format is normative — every NexGrid
...
/// <summary>
/// Exactly one page of rows plus the FULL filtered count, as every NexGrid
/// adapter expects it.
/// </summary>
