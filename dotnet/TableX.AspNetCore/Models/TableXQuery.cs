// The client -> server half of the TableX contract.
//
...
// allowlist registered in TableXQueryOptions; see TableXQueryableExtensions.
...
/// <summary>
/// A TableX page/sort/search/filter request, bound from the query string.
/// </summary>
/// <remarks>
/// <para>
/// In an MVC or API controller the type binds itself — the
/// <see cref="ModelBinderAttribute"/> below points at
/// <see cref="TableXQueryModelBinder"/>, so no startup registration is needed:
/// </para>
/// <code>
/// [HttpGet("/api/students")]
/// public Task&lt;PagedResponse&lt;Student&gt;&gt; Get(TableXQuery query) => ...;
/// </code>
/// <para>
/// In a minimal API the <see cref="BindAsync(HttpContext)"/> hook does the same job:
/// </para>
/// <code>
/// app.MapGet("/api/students", (TableXQuery query, AppDbContext db) => ...);
/// </code>
/// <para>
...
/// </para>
/// </remarks>
[ModelBinder(BinderType = typeof(TableXQueryModelBinder))]
public sealed class TableXQuery
{
    ...
    public static TableXQuery Default { get; } = new();
    ...
    /// <summary>
    /// Parse a TableX query out of an <see cref="IQueryCollection"/>.
    /// </summary>
    ...
    public static TableXQuery Parse(IQueryCollection? query)
    {
    ...
    /// <summary>
    /// Parse a TableX query out of a raw query string, with or without the
    ...
    /// <returns>A query with every value already coerced into range.</returns>
    public static TableXQuery Parse(string? queryString)
    {
    ...
    /// <see cref="TableXQuery"/> parameter on a route handler.
    /// </summary>
    /// <param name="httpContext">The current request.</param>
    /// <returns>The parsed query; never <see langword="null"/> and never faults.</returns>
    public static ValueTask<TableXQuery?> BindAsync(HttpContext httpContext)
    {
        ArgumentNullException.ThrowIfNull(httpContext);
        return ValueTask.FromResult<TableXQuery?>(Parse(httpContext.Request.Query));
    }
