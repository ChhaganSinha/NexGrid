...
/// <summary>
/// Declares one column of a <see cref="TableXTagHelper">&lt;nex-grid&gt;</see>.
/// </summary>
/// <remarks>
/// <example>
/// <code>
...
/// </example>
/// </remarks>
[HtmlTargetElement(TagName, ParentTag = TableXTagHelper.TagName, TagStructure = TagStructure.WithoutEndTag)]
public class TableXColumnTagHelper : TagHelper
{
    ...
    /// matched case-insensitively. Defaults to <see cref="TableXColumnAlign.Left"/>.
    /// </summary>
    ...
    /// <see cref="TableXQueryOptions{T}.Filterable(string, System.Linq.Expressions.Expression{System.Func{T, object}})"/>
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (context.Items.TryGetValue(typeof(TableXColumnCollection), out var bag) &&
            bag is TableXColumnCollection columns)
        {
            columns.Add(ToConfig(Field));
        }
    }

    private TableXColumnConfig ToConfig(string field)
    {
        var meta = new TableXColumnMetaConfig
        {
            ...
            MinWidth = MinWidth,
            Flex = Flex,
            Align = TableXConfigSerializer.ToToken(
                TableXAttribute.ParseEnum<TableXColumnAlign>(Align, TagName, "align")),
            Hidden = Hidden,
            Hideable = Hideable,
...
internal sealed class TableXColumnCollection : List<TableXColumnConfig>
{
}
